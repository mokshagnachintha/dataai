...
from dataai.core.prompts.generate_system_message import GenerateSystemMessagePrompt
...
class LLM:
    ...
    def is_pandasai_llm(self) -> bool:
        """
        Return True if the LLM is from dataai.

        Returns:
            bool: True if the LLM is from dataai
